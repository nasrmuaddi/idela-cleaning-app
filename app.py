...
QUESTION_NAME_MAP = {mapping_json}
...
base = Path("/mnt/data/idela_streamlit_app_v3")
base.mkdir(exist_ok=True)
(base / "app.py").write_text(app_py.strip() + "\n", encoding="utf-8")
(base / "requirements.txt").write_text("streamlit\npandas\nopenpyxl\nxlsxwriter\n", encoding="utf-8")
(base / "README.md").write_text("# IDELA Cleaning App\n\nStreamlit web app for IDELA cleaning and analysis.\n", encoding="utf-8")

zip_path = Path("/mnt/data/idela_streamlit_app_v3.zip")
